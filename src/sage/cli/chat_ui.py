...
def print_chat_enter_banner(*, use_rich: bool, session_id: str = "") -> None:
    if use_rich:
        ...
        body = (
            ...
            "[bold #fbbf24]/clear[/bold #fbbf24] [dim]reset ·[/dim] "
            "[bold #fbbf24]/history[/bold #fbbf24] [dim]last turns ·[/dim] "
            "[bold #fbbf24]/paste[/bold #fbbf24] [dim]multiline ·[/dim] "
            "[bold #fbbf24]/run[/bold #fbbf24] [dim]pipeline ·[/dim] "
            "[bold #fbbf24]/context[/bold #fbbf24] [dim]workspace ·[/dim] "
            "[bold #fbbf24]/model[/bold #fbbf24] [dim]model ·[/dim] "
